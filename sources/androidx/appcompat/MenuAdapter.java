...
public class MenuAdapter extends BaseAdapter {
    ...
    public MenuItemImpl mo32getItem(int position) {
        ArrayList<MenuItemImpl> items = this.mOverflowOnly ? this.mAdapterMenu.getNonActionItems() : this.mAdapterMenu.getVisibleItems();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int currGroupId = mo32getItem(position).getGroupId();
        int prevGroupId = position + (-1) >= 0 ? mo32getItem(position - 1).getGroupId() : currGroupId;
        ...
        itemView.initialize(mo32getItem(position), 0);
        return convertView;
    }
