...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public SupportMenuItem mo34setActionView(View view) {
        int i;
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    /* renamed from: setActionView  reason: collision with other method in class */
    public SupportMenuItem mo33setActionView(int resId) {
        Context context = this.mMenu.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        mo34setActionView(inflater.inflate(resId, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
    ...
    public SupportMenuItem mo36setShowAsActionFlags(int actionEnum) {
    ...
    public SupportMenuItem mo35setContentDescription(CharSequence contentDescription) {
    ...
    public SupportMenuItem mo37setTooltipText(CharSequence tooltipText) {
